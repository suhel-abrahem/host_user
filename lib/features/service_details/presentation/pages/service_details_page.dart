  ...
  Future<void> pickImages() async {
    ...
    await showDialog(
      ...
      if (source == ImageSource.camera) {
        ...
        picker
            .pickMultiImage(
              limit: (files?.length ?? 0) < 5 ? 5 - (files?.length ?? 0) : 0,
            )
            .then((pickedFiles) {
                                              ...
                                              Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  ...
                                                  border: Border.all(
                                                    color: Theme.of(
                                                      context,
                                                    ).defaultBorderSide.color,
                                                    width: Theme.of(
                                                      context,
                                                    ).defaultBorderSide.width,
                                                  ),
                                                ),
                                                child: ImageWidget(
                                                  width: 80.w,
          ...
          AnimatedPositionedDirectional(
            ...
            child: GestureDetector(
              onVerticalDragUpdate: (details) {
                ...
                if (showBookingDetailsPosition + -details.delta.dy > -200.h &&
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: Theme.of(context).shadowColor.withValues(
                        alpha: 1 * (showBookingDetailsPosition + 600.h) / 600.h,
                      ),
                      blurRadius: 1.r,
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Align(
                        ...
                        child: Text(
                          LocaleKeys.serviceDetailsPage_describeYourIssue.tr(),
                          style: Theme.of(context).textTheme.labelLarge
                              ?.copyWith(
                                fontFamily: FontConstants.fontFamily(
                                  context.locale,
                    ...
                    LayoutBuilder(
                      builder: (context, constraints) {
                        if (storeBookingModel.attachments?.isEmpty ?? true) {
                          return SizedBox(
                            height: 100.h,
                            width: 100.w,
                            child: ElevatedButton(
                            ...
                            children: [
                              SizedBox(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemCount:
                                      storeBookingModel.attachments?.length ??
                                      0,
                                  itemBuilder: (context, index) {
                                    return Stack(
                                      children: [
          ...
          AnimatedPositionedDirectional(
            ...
            child: GestureDetector(
              onVerticalDragUpdate: (details) {
                ...
                if (showBookingSchedulePosition + -details.delta.dy > -200.h &&
                  ...
                  children: [
                      ...
                      decoration: BoxDecoration(
                        color:
                            ...
                            ? Theme.of(
                                ...
                                alpha:
                                    1 *
                                    (showBookingSchedulePosition + 220.h) /
                                    220.h,
                              )
                            : Theme.of(context).textTheme.labelLarge?.color,
                        borderRadius: BorderRadius.circular(12.r),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: Text(
                          LocaleKeys.serviceDetailsPage_ConfirmBooking.tr(),
                          style: Theme.of(context).textTheme.labelLarge
                              ?.copyWith(
                                fontFamily: FontConstants.fontFamily(
                                  context.locale,
