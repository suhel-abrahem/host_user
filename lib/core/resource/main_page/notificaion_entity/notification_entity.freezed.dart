...
mixin _$NotificationEntity {
 ...
 int? get id; String get title; String get body; String get type; Map<String, dynamic>? get data;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,body,type,const DeepCollectionEquality().hash(data));

@override
String toString() {
  return 'NotificationEntity(id: $id, title: $title, body: $body, type: $type, data: $data)';
}
...
@useResult
$Res call({
 int? id, String title, String body, String type, Map<String, dynamic>? data
});
...
/// Create a copy of NotificationEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? title = null,Object? body = null,Object? type = null,Object? data = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String title,  String body,  String type,  Map<String, dynamic>? data)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NotificationEntity() when $default != null:
return $default(_that.id,_that.title,_that.body,_that.type,_that.data);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  String title,  String body,  String type,  Map<String, dynamic>? data)  $default,) {final _that = this;
switch (_that) {
case _NotificationEntity():
return $default(_that.id,_that.title,_that.body,_that.type,_that.data);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  String title,  String body,  String type,  Map<String, dynamic>? data)?  $default,) {final _that = this;
switch (_that) {
case _NotificationEntity() when $default != null:
return $default(_that.id,_that.title,_that.body,_that.type,_that.data);case _:
  return null;
...
class _NotificationEntity implements NotificationEntity {
  const _NotificationEntity({this.id = 0, this.title = "", this.body = "", this.type = "", final  Map<String, dynamic>? data = const {}}): _data = data;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,body,type,const DeepCollectionEquality().hash(_data));
...
/// Create a copy of NotificationEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? title = null,Object? body = null,Object? type = null,Object? data = freezed,}) {
